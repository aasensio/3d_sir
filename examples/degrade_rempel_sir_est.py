...
output_spectral_stokes = '/scratch1/3dcubes/rempel_stokes_est_degraded_sir.h5'
...
output_spectral_stokes = '/scratch1/3dcubes/rempel_stokes_invert_est_degraded_sir.h5'
